    	...
    	<div class="section group">
			...
			<table class="tblone" style="width:100%;height: 100%; text-align:center;font-size: 20px;margin-bottom: 50px;">
				...
				<tr style="margin-top: 40px;">
					<td colspan="3"style="justify-content: center;justify-items: center;text-align: center;margin-top: 40px;margin-bottom:10px;"><a href="editprofile.php" style="text-align:center;">Cập nhật thông tin</a></td>
