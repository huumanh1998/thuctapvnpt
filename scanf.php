...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        ...
        $insertScanf = $sc->insert_scanf($_POST,$_FILES);
...
<div class="scanf" style="justify-content: center;justify-items: center;margin-top: 20px; margin-bottom:30px;">
	    		<h2>Gửi giấy tờ</h2>
	    		 <?php
                if(isset($insertScanf)){
                    echo $insertScanf;
                }
                ?>

	    		<form action="scanf.php" method="post" enctype="multipart/form-data">
            <table class="tblone" style="width:100%;height: 100%; font-size: 18px;margin-bottom: 50px;">
               <?php
                ...
                <tr>
                    ...
                    <td>
                        <select style="height:35px;" id="select" name="departmentId">
                ...
                <tr>
                    ...
                    <td>
                        <li class="agileits-main"><input style="margin-top:0px;width: 235px;height: 10px;margin-bottom: 10px;background: #ffffff;border: 1px solid #000;color:#000;" class="date" id="datepicker" name="date_scanf" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '---dd/mm/yyyy---';}" required="" /></li>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top; padding-top: 9px;">
                    ...
                    <td>
                        <textarea id="editor1" name="scanf_desc" class="tinymce"  cols="30" rows="10"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input  type="file" name="scanf_file" />
                    </td>
                </tr>
                <tr>
                    <td></td>
				...
				?>
                    <td>
                        <input style="margin-top:10px; width: 200px; height: 35px;cursor: pointer;" type="submit" name="submit" Value="Gửi" />
                    </td>
                </tr>
                <tr style="margin-top: 30px;">
					<td colspan="3"style="justify-content: center;justify-items: center;text-align: center;margin-bottom:10px;"><a href="viewscanf.php" style="text-align:center;font-size:20px;font-weight: bold;color:,#e69f06;">Xem giấy tờ</a></td>
